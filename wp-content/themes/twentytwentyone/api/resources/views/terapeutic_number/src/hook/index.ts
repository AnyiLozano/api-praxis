...
const useApp = () => {
    ...
    const getContents = () => {
        axios.get("http://api-praxis.eml.com.co/wp-json/admin/terapeutic-number/get-terapeutic-number-contents")
            .then((res) => {
    ...
    const changeStatus = (id: number) => {
        axios.post("http://api-praxis.eml.com.co/wp-json/admin/terapeutic-number/change-status", {id})
        .then((res) => {
