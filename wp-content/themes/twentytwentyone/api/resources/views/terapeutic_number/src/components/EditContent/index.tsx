...
import useCreateContent from "../CreateContent/hook";
import Select from "react-select";

const EditContent: FC<IEditContent> = (props) => {
    const { showModal, closeModal, data_edit } = props;


    /** Controllers */
    const { control, handleSubmit, reset, setValue, handleEditContent, image, setImage, setImageResult } = useEditContent();
    const { typeContents } = useCreateContent();
