...
class TerapeuticNumber {
    ...
    public function TerapeuticNumberView()
    {
        ...
        $html .= '  <script src="'. get_template_directory_uri() . '/api/resources/views/terapeutic_number/public/js/app.js' .'"></script>';
        $html .= '</body>';
        $html .= '</html>';
