...
class HomeController extends Controller
{
     ...
     */
    public function createHomeContents($request)
    {
        global $wpdb;
    ...
    public function editHomeContents($request)
    {
        global $wpdb;
    ...
    {
        $homeContents = ContentPage::with(['page', 'status', 'type_content'])->wherePageId(1)->get();
