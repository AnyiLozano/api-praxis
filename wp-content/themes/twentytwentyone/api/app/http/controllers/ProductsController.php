...
class ProductsController extends Controller
{
     ...
     */
    public function createProductsContents($request)
    {
        global $wpdb;
    ...
    public function editProductsContents($request)
    {
        global $wpdb;
    ...
    {
        $homeContents = ContentPage::with(['page', 'status', 'type_content'])->wherePageId(3)->get();
