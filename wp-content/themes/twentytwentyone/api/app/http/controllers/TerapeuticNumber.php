...
class TerapeuticNumberController extends Controller
{
     ...
     */
    public function createTerapeuticNumberContents($request)
    {
        global $wpdb;
    ...
    public function editTerapeuticNumberContents($request)
    {
        global $wpdb;
    ...
    public function getTerapeuticNumberContents()
    {
        $homeContents = ContentPage::with(['page', 'status', 'type_content'])->wherePageId(2)->get();
